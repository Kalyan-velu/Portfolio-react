...
import {interpolateColors} from '../logic/SkillLogic';
import "../style/Skills.scss"

const Wave = ({ flip, startColor, endColor }) => {
   ...
   useEffect(() => {
      ...
      function updateColors() {
         const steps = 6;
         const newColors = interpolateColors(startColor, endColor, steps);
         setColors(newColors);
      }
   ...
   useEffect(() => {
      if (flip) {
         wavesRef.current.style.transform = "rotate(180deg)";
      }
   }, [flip]);
